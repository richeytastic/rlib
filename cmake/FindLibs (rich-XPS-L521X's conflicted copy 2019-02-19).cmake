...
if(WITH_VTK)    # VTK
    ...
    if(UNIX)
        get_filename_component( VTK_LIBRARY_DIR "${VTK_BIN}/../lib" ABSOLUTE)
    endif()
...
if(WITH_QT)     # Qt5
    ...
    get_filename_component( QT_INSTALLER_FRAMEWORK "$ENV{QT5}/../../Tools/QtInstallerFramework/3.0/bin" ABSOLUTE)
    ...
    find_package( Qt5 CONFIG REQUIRED Widgets Svg Charts)
    ...
    #set( QT_LIBRARIES Qt5::Widgets Qt5::Svg Qt5::Charts)

    get_filename_component( QT_LIB_DIR "${Qt5_DIR}/../.." ABSOLUTE)
...
if(WITH_DLIB)   # dlib
    ...
    get_filename_component( dlib_LIBRARY_DIR "${dlib_DIR}/../.." ABSOLUTE)
...
if(WITH_LUA)
    ...
    elseif(WIN32)
        set( LUA_LIBRARIES "${LUA_LIBRARY_DIR}/lua53.dll")
    endif()
